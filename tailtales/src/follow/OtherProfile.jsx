  ...
  return (
    <div>
      ...
      <main>
        <img
          id="profile-pic"
          src={userData.profilePic || "../img/default-profile-image.jpg"}
        ...
        <section id="posts-section" className={styles.publicaciones}>
          {posts.map((post) => (
            <div key={post.id} className={styles.publicacion}>
              ...
              <button
                className={styles.editarPostButton}
                onClick={() => handlePostModalOpen(post)}
              >
                Editar
              </button>
              <button
                className={styles.eliminarPostButton}
                onClick={async () => {
